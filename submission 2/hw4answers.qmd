...
This is rendering weridly but the code in my R script gives me a regression table. 
```{r}
#| echo: false
#| label: ratings3
...
This is rendering weridly but the code in my R script gives me two graphs that have differnet colors for different threshold values. 
...
I'm having trouble finding anything about HMO groups in the plan characteristics. Using the code for number 4, I don't know how to add threshold values. 

If the question is supposed to be similar to question 8, then I would do this code: 
...
But I would add HMO and Part D characteristics. 
