...
I think the number of plans is sufficient. The fact that there are around 20 plans in each county suggests a reasonable level of choice and competition among healthcare plans. This number indicates that consumers have multiple options to choose from, which is generally considered beneficial as it allows them to select plans that best suit their needs in terms of coverage, cost, and provider network.
...
The distribution has changed because the ratings have gotten higher over time. There were more 2.5s in 2010, then in 2012 it was concentrated in 3s, and then the most 4s were in 2015. 
...
It has overall increased in popularity from 2010-2015. It somewhat correlates with the benchmark payment because it also increased until 2014, but then they seem to not correlate after 2014. 
...
The findings are sensitive as the estimates get higher with larger bandwith. 
A rating of 3 increases at a more drastic rate than 3.5. People care about avoiding "bad" plans but don't necessarily care if their plan is only marginally worse than another, if they both have "good" ratings. 
...
Also, we know that the jump from 2.5 to 3 may be more effective than the jump from 3 to 3.5. This is also intuative because people want to avoid "bad plans" but may not care if two already "good" plans if one is marginally better. 
